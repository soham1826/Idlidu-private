...
import { BiFace, BiMap,  } from "react-icons/bi";
   ...
   <Container>
    <div className="max-w-screen-lg mx-auto">
        <div className="flex flex-col gap-6">
            <ListingHead title ={listing.title} imageSrc={listing.imageSrc} locationValue={listing.locationValue} city={listing.city} state={listing.state} id={listing.id}
