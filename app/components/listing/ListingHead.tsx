...
const ListingHead:React.FC<ListingHeadProps> =({title,locationValue,imageSrc,id,currentUser,city,state})=>{
    ...
    return (
        ...
        <div className="pt-12 mt-8">
            ...
            <Heading title={title} subtitle={`${city}, ${state},${location?.label}`}/>
